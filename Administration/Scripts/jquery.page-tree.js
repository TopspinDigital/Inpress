$.fn.buildTree = function (pageSettings) {
    ...
    ***************************************************************************************************************/
    ...
    function bindEvents() {
        $('div.item').on('mouseenter', function () {
            $(this).addClass('hover');
        ...
        if (pageSettings.selectable) {
            $('li > div.item > span.title').on('click', function () {
            ...
            $('li > span.tick').on('click', function () {
                if (pageSettings.selectChildren) {
        ...
        $('li > div.item > span.arr').on('click', function () {
            var arr = $(this);
                ...
                if (o.success) {
                    if (o.tree != '') {
                        ...
                        if (pageSettings.selectable) {
                            ...
                            $('li', treeRoot).addClass("no-select");
                        }
                        ...
                        if (pageSettings.editing) {
                            $('.actions', treeRoot).show();
                        }
